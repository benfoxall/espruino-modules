...
var connect = function(callback) {
  ...
  if (b=="HYSTM32_24") {
    ...
    ADS7843.connect(SPI1, B7, B6, -16, 256, 352, -272, callback);
  } else if (b=="HYSTM32_28") {
    SPI1.setup({sck:A5,miso:A6,mosi:A7});
    ADS7843.connect(SPI1, A4, C13, 336, -16, -352, 272, callback);
  } else if (b=="HYSTM32_32") {
    SPI1.setup({sck:A5,miso:A6,mosi:A7});
    ADS7843.connect(SPI1, A4, B6, -16, -16, 352, 272, callback);
  } else
...
export { connect };export default Touchscreen;
