...
var connect = function(i2c, callback, options) {
  update(options);
...
var connectSPI = function(spi, dc,  rst, callback, options) {
  update(options);
...
var SSD1306 = {
	connect: connect,
	connectSPI: connectSPI
};

export { connect, connectSPI };export default SSD1306;
