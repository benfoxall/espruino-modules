...
var EspruinoWiFi = createCommonjsModule(function (module, exports) {
var WIFI_BOOT = A13;
var WIFI_CHPD = A14;
...
function turnOn(mode, callback) {
  ...
  if (wasOff) {
    ...
    at = AT.connect(WIFI_SERIAL);  
    at.register("+IPD", ipdHandler);
    exports.at = at;
    NetworkJS.create(netCallbacks);
    at.cmd("\r\nAT+RST\r\n", 10000, function cb(d) {
...
var EspruinoWiFi_1 = EspruinoWiFi.at;
var EspruinoWiFi_2 = EspruinoWiFi.connect;
var EspruinoWiFi_3 = EspruinoWiFi.disconnect;
var EspruinoWiFi_4 = EspruinoWiFi.getIP;
var EspruinoWiFi_5 = EspruinoWiFi.startAP;
var EspruinoWiFi_6 = EspruinoWiFi.stopAP;
var EspruinoWiFi_7 = EspruinoWiFi.scan;

export { EspruinoWiFi_1 as at, EspruinoWiFi_2 as connect, EspruinoWiFi_3 as disconnect, EspruinoWiFi_4 as getIP, EspruinoWiFi_5 as startAP, EspruinoWiFi_6 as stopAP, EspruinoWiFi_7 as scan };export default EspruinoWiFi;
