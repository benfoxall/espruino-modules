...
var connect = function(spi, dc, ce, rst, callback) {
...
var connectPaletted = function(palette, spi, dc, ce, rst, callback) {
  var bits;
...
var ILI9163 = {
	connect: connect,
	connectPaletted: connectPaletted
};

export { connect, connectPaletted };export default ILI9163;
